...
def conduct_experiment(**hyper_parameters):
    ...
    for filename in glob.glob("../images/*.*"):
        ...
        pil_original_image = Image.open(filename).transpose(Image.FLIP_TOP_BOTTOM)
        ...
        evaluation = evaluate(pil_resized_image, stroke_sequence, np_padded_mask_resized)
        evaluations.append(evaluation)
        # print("Evaluation", evaluation)
    
    return sum(evaluations)/len(evaluations) # average

    # ## Stroke Reordering

    # TODO: fix color reordering
    # color_buckets = {}
